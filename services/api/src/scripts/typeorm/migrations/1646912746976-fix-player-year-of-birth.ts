...
export class fixPlayerYearOfBirth1646912746976 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`player\` CHANGE \`dateOfBirth\` \`yearOfBirth\` date NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`player\` CHANGE \`yearOfBirth\` \`dateOfBirth\` date NOT NULL`);
    }
